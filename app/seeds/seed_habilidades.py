...
HABILIDADES_SEED = [
    ...
    {
        "nome": "Consumo de APIs (REST / GraphQL)",
        "tipo": TipoHabilidadeEnum.HARD,
        "categoria": "Frontend",
    },
    # Backend (HARD)
    {
        "nome": "Node.js (Express / NestJS)",
        "tipo": TipoHabilidadeEnum.HARD,
        "categoria": "Backend",
    },
    {
        "nome": "Python (FastAPI / Django)",
        "tipo": TipoHabilidadeEnum.HARD,
        "categoria": "Backend",
    },
    {
    ...
    {
        "nome": "Criação de APIs RESTful e WebSockets",
        "tipo": TipoHabilidadeEnum.HARD,
        "categoria": "Backend",
    },
    ...
    {
        "nome": "SQLAlchemy / Prisma / TypeORM",
        "tipo": TipoHabilidadeEnum.HARD,
        "categoria": "Banco de Dados",
    },
    {
        "nome": "Modelagem Relacional e NoSQL",
        "tipo": TipoHabilidadeEnum.HARD,
        "categoria": "Banco de Dados",
    },
    ...
    {
        "nome": "AWS (S3, EC2, Lambda)",
        "tipo": TipoHabilidadeEnum.HARD,
        "categoria": "DevOps & Cloud",
    },
    {
        "nome": "CI/CD (GitHub Actions / GitLab)",
        "tipo": TipoHabilidadeEnum.HARD,
        "categoria": "DevOps & Cloud",
    },
    {
    ...
    {
        "nome": "Testes Automatizados (Jest, Pytest, Cypress)",
        "tipo": TipoHabilidadeEnum.HARD,
        "categoria": "Arquitetura & Qualidade",
    },
    {
        "nome": "Segurança & Autenticação (JWT, OAuth2)",
        "tipo": TipoHabilidadeEnum.HARD,
        "categoria": "Arquitetura & Qualidade",
    },
    # Soft Skills (SOFT)
    {
        "nome": "Comunicação Clara e Articulada",
    ...
    {
        "nome": "Adaptabilidade e Aprendizado Rápido",
        "tipo": TipoHabilidadeEnum.SOFT,
        "categoria": "Comportamental",
    },
    {
    ...
    {
        "nome": "Pensamento Crítico e Análise",
        "tipo": TipoHabilidadeEnum.SOFT,
        "categoria": "Comportamental",
    },
    {
        "nome": "Liderança e Mentoria Técnica",
        "tipo": TipoHabilidadeEnum.SOFT,
        "categoria": "Comportamental",
    },
    {
        "nome": "Gestão de Conflitos e Inteligência Emocional",
        "tipo": TipoHabilidadeEnum.SOFT,
        "categoria": "Comportamental",
    },
]
...
def seed_habilidades(db: Session = None):
    ...
    try:
        ...
        for item in HABILIDADES_SEED:
            existe = (
                db.query(Habilidade).filter(Habilidade.nome == item["nome"]).first()
            )
            if not existe:
                nova_hab = Habilidade(
                    id=uuid.uuid4(),
